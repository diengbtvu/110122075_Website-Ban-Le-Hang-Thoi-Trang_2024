...
<main class='invoice'>
  <div class='invoice-wrapper'>
    <img
      src='../assets/images/logo/MH-logo.png'
      alt='logo' class='invoice-logo'>
    <div class='invoice-company'>
      <h2 class='invoice-company-name'>MH-Shop</h2>
      <p class='invoice-company-address'>
        <span>Khóm 5,</span>
        <span>Phường 5, Thành phố Trà Vinh</span>
        <span>110122075@St.tvu.edu.vn</span>
      </p>
    </div>
  </div>
  <div class='invoice-wrapper'>
    <div class='invoice-billing'>
    <h2 class="invoice-info-value" style="font-size: 10px;">CHI TIẾT GIAO HÀNG</h2>
    <br>
      <?php
        echo '
        ...
        <div class="invoice-details">
            <div class="invoice-info">
                <span class="invoice-info-key">Số hoá đơn:</span>
                <span class="invoice-info-value">'.$kq_order[0]['invoice_id'].'</span>
            </div>
            <div class="invoice-info">
                <span class="invoice-info-key">Số khách hàng:</span>
                <span class="invoice-info-value">'.$kq_order[0]['id_user'].'</span>
            </div>
            <div class="invoice-info">
                <span class="invoice-info-key">Ngày đến hạn:</span>
...
<!-- <div class="invoice-info">
      ...
      <div>
        <div style="float: right; width: 17%;">
          <?php
            ...
            {
              echo '<h3 style="color: red;">Tổng tiền: '.number_format($kq_order[0]["total_prices"]). '</h3>';
            }
          ?>
        </div>
      </div>
  <div class="button-wrapper">
    ...
    <button class="custom-button"><a href="../admin/admin.php?act=invoice" class="axil-btn btn-bg-primary checkout-btn">Trang chủ</a></button>
</div>
</main>
