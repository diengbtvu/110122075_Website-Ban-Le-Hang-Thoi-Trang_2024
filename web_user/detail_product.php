                                ...
                                <div class="inner">
                                    ...
                                    <div class="product-rating">
                                        ...
                                        <div class="review-link">
                                            <a href="#">(<span>2</span> người đánh giá)</a>
                                        </div>
                                    </div>
                                    <ul class="product-meta">
                                    ...
                                    <div class="product-action-wrapper d-flex-center">
                                        <form id="slider_product_'.$i.'" action="fashionApp.php?act=add_cart" method="POST">
                                            ...
                                            <label style="color: red; font-weight: bold;">Số lượng:</label>
                                        ...
                                        <ul class="product-action d-flex-center mb--0">';
                                            ...
                                            if ($detail_product[0]["quantity"] != 0) {
                                                echo '
                                                    <li class="add-to-cart"><a href="javascript:void(0);" onclick="submitForm('.$i.')" class="axil-btn btn-bg-primary">Thêm vào giỏ hàng</a></li>
